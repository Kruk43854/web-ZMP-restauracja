...
const bestsellers = [
  {
    id: 1,
    name: "Pizza Margherita Autentico",
    description: "Klasyczna neapolitańska pizza z pomidorami San Marzano, świeżą mozzarellą di bufala i bazylią.",
    price: "36 zł",
    image: "/pizza.jpg"
  },
  {
    ...
    description: "Królowa włoskich steków. Potężny kawałek wołowiny z kością, grillowany z solą morską i rozmarynem.",
    price: "140 zł",
    image: "/steak.jpg" 
  },
  {
    ...
    description: "Ręcznie robiony makaron tagliatelle otulony aksamitnym sosem z czarnej trufli i parmezanem.",
    price: "48 zł",
    image: "/pasta.jpg" 
  }
];
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center max-w-7xl mx-auto">
    ...
    <div className="text-lg text-gray-800 leading-relaxed text-justify md:text-left space-y-6">
        <h2 className="text-5xl font-bold font-fancy mb-16 text-left text-black">Kim jesteśmy?</h2>
    ...
    <div className="relative transform hover:scale-105 transition-transform duration-500">
      ...
      <div className="absolute -bottom-6 italic font-fancy bg-white p-4 rounded-2xl shadow-xl text-4xl md:right-6 ">
        Giorgio & Leonardo
      </div>
    </div>    
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            Dania, dla których goście wracają do nas każdego dnia.
          </p>
        </div>

        <div className="relative w-full max-w-4xl mx-auto">
          
          <div className="bg-gray-50 rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row items-center border border-gray-100">
